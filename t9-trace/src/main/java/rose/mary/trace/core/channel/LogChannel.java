 ...
 * @since Jul 29, 2019
 */
public abstract class LogChannel implements Runnable {
	...
	public LogChannel(String name, boolean autoCommit, int commitCount, long maxCommitWait, long delayForNoMessage,
