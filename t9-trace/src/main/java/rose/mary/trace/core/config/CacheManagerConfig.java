...
public class CacheManagerConfig {
	...
	public int getCheckSizeDelay() {
		return checkSizeDelay;
	}

	public void setCheckSizeDelay(int checkSizeDelay) {
		this.checkSizeDelay = checkSizeDelay;
	}
	...
	public CacheConfig getDbCacheConfig() {
